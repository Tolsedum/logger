...
namespace archive{
    ...
    public:
         ...
         */
        void addDirs(
            std::map<std::string, std::string> name_dirs
        );
         ...
         */
        void addDir(
            std::string dir_source, std::string dir_destination
        );
         ...
         */
        void addFile(
            std::string file_source, std::string file_destination
        );
